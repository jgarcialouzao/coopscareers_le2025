...
use ../dta/fpanel.dta, clear

keep year_mcvl idplant idfirm legal* type* provinceplant creation_date CNAE* regime size
...
gen partner = (type1plant==930 & socialeco==2) | (type1plant==951 &  socialeco==3)
...
replace sector1d=13 if sector2d==84 | sector2d==99
...
*Keep only obs, plant characteristics are fixed except for age that will be computed later
qui bys idplant: keep if _n == 1
qui drop year_mcvl 

save ../dta/firms.dta, replace
